...
const s = {
  ...
  backBtn: { background: 'none', border: '1px solid var(--border-2)', color: 'var(--text-subtle)', padding: '8px 14px', borderRadius: '8px', cursor: 'pointer', fontSize: '0.85rem', whiteSpace: 'nowrap', marginTop: '4px', display: 'inline-flex', alignItems: 'center' },
  title: { fontSize: '1.8rem', fontFamily: '"Playfair Display", Georgia, serif', marginBottom: '0.3rem' },
  sub: { color: 'var(--text-faint)', fontSize: '0.85rem' },
  ...
  warnText: { color: 'var(--text-muted)', fontSize: '0.88rem', marginBottom: '0.5rem' },
  warnList: { color: 'var(--text-muted)', fontSize: '0.85rem', lineHeight: 2, paddingLeft: '1.25rem' },
  code: { background: 'rgba(255,255,255,0.08)', padding: '2px 6px', borderRadius: '4px', fontSize: '0.8rem', fontFamily: 'monospace', color: '#FFD700' },

  // Card form
  card: { background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '14px', padding: '2rem' },
  ...
  label: { display: 'block', color: 'var(--text-subtle)', fontSize: '0.8rem', marginBottom: '8px', letterSpacing: '0.04em' },
  stripeInput: { padding: '14px', background: 'var(--surface-2)', border: '1px solid var(--border-2)', borderRadius: '8px', minHeight: '48px' },
  ...
  // Security info
  secInfo: { display: 'flex', flexDirection: 'column', gap: '0.5rem', padding: '1rem', background: 'var(--surface-3)', borderRadius: '10px', border: '1px solid var(--border)' },
  secItem: { display: 'flex', alignItems: 'center', gap: '10px', color: 'var(--text-faint)', fontSize: '0.82rem' },

  // Summary
  summary: { background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '14px', padding: '1.75rem', position: 'sticky', top: '80px' },
  summaryTitle: { fontSize: '1rem', fontWeight: 700, marginBottom: '1.25rem', color: 'var(--text)' },
  ...
  itemQty: { color: 'var(--text-faint)', fontSize: '0.78rem' },
  itemPrice: { color: '#FFD700', fontWeight: 700, fontSize: '0.88rem', whiteSpace: 'nowrap' },
  divider: { height: '1px', background: 'var(--border)', margin: '1rem 0' },
  summaryRow: { display: 'flex', justifyContent: 'space-between', color: 'var(--text-muted)', fontSize: '0.88rem', marginBottom: '0.5rem' },
  totalRow: { color: '#FFD700', fontSize: '1.1rem', fontWeight: 800, marginTop: '0.25rem' },
  addressBox: { marginTop: '1.25rem', padding: '1rem', background: 'var(--surface-3)', borderRadius: '8px', border: '1px solid var(--border)' },
  addressLabel: { color: 'var(--text-faint)', fontSize: '0.72rem', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: '0.5rem' },
  addressText: { color: 'var(--text-muted)', fontSize: '0.85rem', lineHeight: 1.6 },
};
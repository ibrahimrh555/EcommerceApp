...
const styles = {
  ...
  header: {
    background: 'linear-gradient(135deg, var(--surface-3) 0%, var(--bg) 100%)',
  ...
  subtitle: { color: 'var(--text-subtle)', fontSize: '0.9rem' },
  ...
  select: {
    ...
    color: 'var(--text)', fontSize: '0.9rem', cursor: 'pointer', outline: 'none',
  },
  categories: { display: 'flex', gap: '0.6rem', flexWrap: 'wrap', marginBottom: '2.5rem' },
  catBtn: {
    padding: '0.45rem 1.1rem', background: 'var(--surface-3)',
    border: '1px solid var(--border-2)', borderRadius: '30px',
    color: 'var(--text-muted)', cursor: 'pointer', fontSize: '0.85rem', transition: 'all 0.2s',
  },
  catBtnActive: { background: 'rgba(255,215,0,0.15)', border: '1px solid #FFD700', color: '#FFD700' },
  loading: { textAlign: 'center', padding: '5rem', color: 'var(--text-subtle)' },
  spinner: {
  ...
  empty: { textAlign: 'center', padding: '5rem', color: 'var(--text-subtle)' },
  emptyTitle: { fontSize: '1.2rem', color: 'var(--text)', margin: '1rem 0 0.5rem' },

...
const styles = {
  ...
  empty: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem', padding: '4rem', textAlign: 'center', color: 'var(--text-subtle)' },
  shopLink: { padding: '10px 24px', background: '#FFD700', color: '#000', borderRadius: '6px', textDecoration: 'none', fontWeight: 700 },
  list: { display: 'flex', flexDirection: 'column', gap: '1rem' },
  orderCard: { display: 'block', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '12px', padding: '1.5rem', textDecoration: 'none', color: 'inherit', transition: 'border-color 0.2s' },
  ...
  orderDate: { color: 'var(--text-subtle)', fontSize: '0.85rem' },
  ...
  orderThumb: { width: '48px', height: '48px', objectFit: 'cover', borderRadius: '6px', border: '1px solid var(--border)' },
  moreItems: { color: 'var(--text-subtle)', fontSize: '0.85rem' },
  orderBottom: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
  orderCount: { color: 'var(--text-subtle)', fontSize: '0.85rem' },

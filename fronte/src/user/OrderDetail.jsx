...
const styles = {
  ...
  date: { color: 'var(--text-subtle)', fontSize: '0.9rem' },
  tracker: { display: 'flex', alignItems: 'center', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '12px', padding: '1.5rem 2rem', marginBottom: '2rem' },
  ...
  section: { background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '12px', padding: '1.5rem' },
  sectionTitle: { fontSize: '1rem', fontWeight: 700, marginBottom: '1.25rem', color: '#FFD700' },
  item: { display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem', paddingBottom: '1rem', borderBottom: '1px solid var(--border)' },
  itemImg: { width: '60px', height: '60px', objectFit: 'cover', borderRadius: '8px' },
  itemInfo: { flex: 1 },
  itemName: { fontWeight: 600, marginBottom: '4px' },
  itemQty: { color: 'var(--text-subtle)', fontSize: '0.85rem' },
  itemPrice: { fontWeight: 700, color: '#FFD700' },
  addrLine: { color: 'var(--text-muted)', fontSize: '0.9rem', marginBottom: '4px' },
  summaryRow: { display: 'flex', justifyContent: 'space-between', marginBottom: '0.75rem', color: 'var(--text-muted)', fontSize: '0.9rem' },

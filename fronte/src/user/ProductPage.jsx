...
const styles = {
  ...
  imageSection: { borderRadius: '16px', overflow: 'hidden', background: '#1a1a2e', aspectRatio: '1' },
  ...
  ratingText: { color: 'rgba(255,255,255,0.5)', fontSize: '0.9rem' },
  price: { fontSize: '2rem', fontWeight: 800, color: '#FFD700' },
  description: { color: 'rgba(255,255,255,0.65)', lineHeight: 1.7, fontSize: '0.95rem' },
  ...
  qtyControl: { display: 'flex', alignItems: 'center', gap: '0', border: '1px solid rgba(255,255,255,0.15)', borderRadius: '8px', overflow: 'hidden' },
  qtyBtn: { background: 'rgba(255,255,255,0.06)', border: 'none', color: '#fff', width: '40px', height: '40px', cursor: 'pointer', fontSize: '1.2rem' },
  ...
  reviewSection: { borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: '3rem' },
  sectionTitle: { fontSize: '1.5rem', fontFamily: '"Playfair Display", Georgia, serif', marginBottom: '2rem' },
  noReviews: { color: 'rgba(255,255,255,0.4)', fontStyle: 'italic' },
  reviewList: { display: 'flex', flexDirection: 'column', gap: '1rem', marginBottom: '2.5rem' },
  reviewCard: { background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '10px', padding: '1.2rem' },
  reviewHeader: { display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '0.75rem', flexWrap: 'wrap' },
  reviewName: { fontWeight: 600, color: '#fff' },
  reviewStars: { color: '#FFD700' },
  reviewDate: { color: 'rgba(255,255,255,0.35)', fontSize: '0.8rem', marginLeft: 'auto' },
  reviewComment: { color: 'rgba(255,255,255,0.65)', lineHeight: 1.6 },
  reviewForm: { background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '12px', padding: '2rem' },
  ...
  textarea: { width: '100%', background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: '8px', color: '#fff', padding: '12px', fontSize: '0.95rem', resize: 'vertical', outline: 'none', boxSizing: 'border-box' },

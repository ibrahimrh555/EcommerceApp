...
const styles = {
  ...
  pageSub: { color: 'rgba(255,255,255,0.4)', fontSize: '0.9rem' },
  ...
  sectionTitle: { fontSize: '1rem', fontWeight: 700, marginBottom: '1.25rem', color: 'rgba(255,255,255,0.8)' },
  table: { width: '100%', borderCollapse: 'collapse' },
  th: { color: 'rgba(255,255,255,0.35)', fontSize: '0.75rem', fontWeight: 600, letterSpacing: '0.07em', textTransform: 'uppercase', padding: '0.5rem 0.75rem', textAlign: 'left', borderBottom: '1px solid rgba(255,255,255,0.07)' },
  tr: { borderBottom: '1px solid rgba(255,255,255,0.04)' },
  td: { padding: '0.75rem', fontSize: '0.88rem', color: 'rgba(255,255,255,0.75)' },
  ...
  statusName: { flex: 1, color: 'rgba(255,255,255,0.6)', fontSize: '0.88rem' },

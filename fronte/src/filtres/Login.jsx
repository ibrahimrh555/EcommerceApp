  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <p style={styles.hint}>Pas encore de compte ? <Link to="/register" style={styles.link}>S'inscrire</Link></p>
        ...
        <div style={styles.demo}>
          <p style={styles.demoLabel}>Compte demo admin :</p>
          <p style={styles.demoText}>admin@shop.com / admin123</p>
        </div>
      </div>
    </div>
  );
...
const styles = {
  ...
  demo: { marginTop: '2rem', padding: '1rem', background: 'rgba(255,215,0,0.08)', borderRadius: '8px', textAlign: 'center' },
  demoLabel: { color: 'rgba(255,255,255,0.4)', fontSize: '0.78rem', marginBottom: '4px' },
  demoText: { color: '#FFD700', fontSize: '0.85rem', fontWeight: 600 },
};
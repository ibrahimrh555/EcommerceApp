...
const styles = {
  ...
  tableWrap: { background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '12px', overflow: 'hidden' },
  ...
  td: { padding: '0.9rem 1rem', fontSize: '0.88rem', color: 'rgba(255,255,255,0.75)' },
  ...
  modal: { background: '#131320', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '14px', padding: '2rem', width: '100%', maxWidth: '600px', maxHeight: '90vh', overflowY: 'auto' },
  ...
  input: { width: '100%', padding: '9px 12px', background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '7px', color: '#fff', fontSize: '0.9rem', outline: 'none', boxSizing: 'border-box' },
  ...
  btnCancel: { padding: '10px 20px', background: 'transparent', border: '1px solid rgba(255,255,255,0.15)', color: 'rgba(255,255,255,0.5)', borderRadius: '8px', cursor: 'pointer', fontSize: '0.9rem' },
};
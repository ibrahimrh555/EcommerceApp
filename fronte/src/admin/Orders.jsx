...
const styles = {
  ...
  tab: { padding: '6px 14px', background: 'var(--surface-3)', border: '1px solid var(--border-2)', borderRadius: '20px', color: 'var(--text-subtle)', cursor: 'pointer', fontSize: '0.82rem' },
  tabActive: { background: 'rgba(255,215,0,0.1)', border: '1px solid #FFD700', color: '#FFD700' },
  tableWrap: { background: 'var(--surface-3)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'auto' },
  ...
  td: { padding: '0.9rem 1rem', fontSize: '0.88rem', color: 'var(--text-muted)', verticalAlign: 'middle' },
  ...
  email: { color: 'var(--text-faint)', fontSize: '0.78rem' },
  ...
  select: { padding: '6px 10px', background: 'var(--surface-2)', border: '1px solid var(--border-2)', borderRadius: '6px', color: 'var(--text)', fontSize: '0.82rem', cursor: 'pointer', outline: 'none' },
  ...
  modal: { background: 'var(--image-bg)', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '14px', padding: '2rem', width: '100%', maxWidth: '560px', maxHeight: '90vh', overflowY: 'auto' },
  modalHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' },
  modalTitle: { fontSize: '1.1rem', fontFamily: '"Playfair Display", serif' },
  closeBtn: { background: 'none', border: 'none', color: 'var(--text-subtle)', fontSize: '1.2rem', cursor: 'pointer' },
  modalGrid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', marginBottom: '1.5rem' },
  detailLabel: { color: 'var(--text-faint)', fontSize: '0.75rem', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: '4px' },
  detailVal: { color: 'var(--text)', fontWeight: 600, fontSize: '0.9rem' },
  detailSub: { color: 'var(--text-subtle)', fontSize: '0.82rem', marginTop: '2px' },
  itemsList: { display: 'flex', flexDirection: 'column', gap: '0.75rem', marginBottom: '1rem' },
  itemRow: { display: 'flex', alignItems: 'center', gap: '12px', padding: '0.6rem', background: 'var(--surface)', borderRadius: '8px', fontSize: '0.88rem' },
  itemImg: { width: '40px', height: '40px', objectFit: 'cover', borderRadius: '6px' },
  modalFooter: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.75rem 0', borderTop: '1px solid var(--border)' },
};
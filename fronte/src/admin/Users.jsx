...
const styles = {
  ...
  searchInput: { width: '100%', maxWidth: '400px', padding: '10px 14px', background: 'var(--surface-2)', border: '1px solid var(--border-2)', borderRadius: '8px', color: 'var(--text)', fontSize: '0.9rem', outline: 'none', boxSizing: 'border-box' },
  ...
  email: { color: 'var(--text-subtle)', fontSize: '0.85rem' },
  ...
  roleUser: { background: 'var(--surface-2)', color: 'var(--text-subtle)', border: '1px solid var(--border-2)' },
